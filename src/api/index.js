...
export const getCategories = async () => {
  return await Axios.get(`${BASE_URL}/categorys/recipes`);
};

export const getCategoriesBykey = async (key) => {
  return await Axios.get(`${BASE_URL}/categorys/recipes/${key}`);
};
export const searchRecipe = async (keyword) => {
  return await Axios.get(`${BASE_URL}/search/?q=${keyword}`);
};

export const detailRecipe = async (key) => {
  return await Axios.get(`${BASE_URL}/recipe/${key}`);
};
